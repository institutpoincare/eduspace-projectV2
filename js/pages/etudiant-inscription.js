// Etudiant Registration Handler
console.log('🚀 Chargement du script d\'inscription étudiant...');

document.addEventListener('DOMContentLoaded', () => {
    console.log('📄 DOM chargé, initialisation du formulaire étudiant...');

    const form = document.getElementById('etudiantInscriptionForm');
    ...
    async function handleSubmit(e) {
        ...
        const newUser = {
            ...
            phone: phone,
            password: password,
            role: 'etudiant', // Explicitly set role to etudiant
